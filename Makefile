SOURCES_PROJECT = main.c hardware_STM32F407G_DISC1.c stm32f4xx_it.c system_stm32f4xx.c lepton_functions.c generic_packet.c gp_receive.c gp_proj_universal.c gp_proj_thermal.c gp_proj_analog.c gp_proj_sonar.c gp_proj_motor.c hardware_TB6612.c quad_encoder.c
